...
productRouter.post("/", (req, res) => {
    ...
    res.send(`Create a new product with ID: ${id}, Title: ${title} and Price: ${price}`);
});
// Actualizar un producto, el enrutador utiliza el metodo patch para actualizar un producto
productRouter.patch("/:id", (req, res) => {
    res.send(`Update the product ${req.params.id} with title ${req.body.title}, and price of ${req.body.price}`);
});
